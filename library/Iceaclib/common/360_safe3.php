...
function StopAttack($arr,$StrFiltKey,$StrFiltValue,$ArrFiltReq){  
...
foreach($_GET as $key=>$value){ 
	StopAttack($_GET,$key,$value,$getfilter);
}
foreach($_POST as $key=>$value){ 
	StopAttack($_POST,$key,$value,$postfilter);
}
foreach($_COOKIE as $key=>$value){ 
	StopAttack($_COOKIE,$key,$value,$cookiefilter);
}
foreach($referer as $key=>$value){ 
	StopAttack($referer,$key,$value,$getfilter);
}
