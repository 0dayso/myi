...
class Iceaclib_common_ftp {
	 ...
	 * 构造函数
	 *
	 * @param	array	配置数组 : $config = array('hostname'=>'','username'=>'','password'=>'','port'=>'21'...);
	 */
	...
	private function _error($msg) {
		return @file_put_contents('../docs/ftp_err.log', "date[".date("Y-m-d H:i:s")."]-hostname[".$this->hostname."]-username[".$this->username."]-password[".$this->password."]-msg[".$msg."]\r\n", FILE_APPEND);
	}
}
