<?php
class Icwebadmin_Model_DbTable_Unuser extends Zend_Db_Table_Abstract
{
	protected $_name = 'un_user';
	...
	public function updateByUnuid($data,$id)
	{
		$this->update($data, "un_uid='{$id}'");
	}
}