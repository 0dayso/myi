...
class Icwebadmin_OasyProdController extends Zend_Controller_Action
{
	private $_filter;
	private $_mycommon;
    ...
    public function indexAction(){
    	$this->view->atspart = array();
    	if($this->_getParam('partno')){
    		$this->view->partno = $this->_getParam('partno');
    		$prefix = substr($this->view->partno,0,3);
    		if($prefix=='IDT'){
    			$sappartno = substr($this->view->partno,3);
    		}else{
    			$sappartno = $this->view->partno;
    		}
    		$this->view->atspart    = $this->_oainquiryService->QueryATSInventoryData($sappartno);
    	}
    }
}