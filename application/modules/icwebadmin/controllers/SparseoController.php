...
class Icwebadmin_SparSeoController extends Zend_Controller_Action
{
	private $_filter;
	private $_mycommon;
    ...
    public function indexAction(){
    	$file = '../application/configs/seoconfig.ini';
    	if($this->getRequest()->isPost()){
    		...
    		//日志
    		if($description){
    			$this->_adminlogService->addLog(array('log_id'=>'E','temp4'=>'更新配置文件seoconfig.ini成功','description'=>$description));
    		}
