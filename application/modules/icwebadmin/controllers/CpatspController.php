...
class Icwebadmin_CpAtspController extends Zend_Controller_Action
{
	private $_filter;
	private $_mycommon;
	private $_atsprice;
    public function init(){
    	...
    	**************************************************************/
    	...
    	$this->_atsprice = new Icwebadmin_Service_ProductatsService();
    	//加载通用自定义类
    	$this->_mycommon = $this->view->mycommon = new MyAdminCommon();
    	$this->_filter = new MyFilter();
    }
    public function indexAction(){
    	$total = $this->_atsprice->getAtsPriceNum();
    	//分页
    	$perpage=50;
    	...
    	$this->view->product = $this->_atsprice->getAtsPrice($offset,$perpage);
    }
}