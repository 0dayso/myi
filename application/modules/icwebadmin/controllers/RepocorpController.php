...
class Icwebadmin_RepoCorpController extends Zend_Controller_Action
{
	private $_filter;
	private $_mycommon;
    ...
    public function indexAction(){
    	if($_GET['sdata']){
    		...
    		$this->view->soprod = $this->_repoService->ordercorpRepo($sql);
    	}
    }
    /**
     * 导出Excel
    ...
    public function exportAction(){
    	...
    	if($_GET['sdata']){
    		...
    		$sql = " AND sp.created BETWEEN '$stmie' AND '$etmie'";
    		$soprod = $this->_repoService->ordercorpRepo($sql);
    		if($soprod){
    			//生成新excel
