<?php
class Default_Model_DbTable_InquiryDetailed extends Zend_Db_Table_Abstract
{
	protected $_name = 'inquiry_detailed';
	...
	public function getOneBySql($sql,$prepare=array())
	{
		$db = $this->getAdapter();
		//'SELECT * FROM example WHERE date > :placeholder', array('placeholder' => '2006-01-01'
		$result = $db->query($sql,$prepare);
