// JavaScript Document 邮箱后缀名自动提示显示输入
    (function ($) {
        $.fn.emailMatch = function (settings) {
            var defaultSettings = {
                emailTip: "", //请输入邮箱地址
				aEmail: ["126.com","139.com","163.com","189.cn","aliyun.com","gmail.com","hotmail.com","qq.com","sina.cn","sina.com","sohu.com","vip.sina.com","wo.com.cn","yahoo.com","yahoo.cn","yahoo.com.cn"],//邮件数组
                wrapLayer: "body",
        ...
        function showList(oElem, w, h, t, l) { // 显示 邮箱框架 并定位.
            ...
            $(".emailtipbox select").css({ "visibility": "hidden" });
        };

        function hideList(oElem) { // 显示 邮箱框架 
            oElem.css({ "display": "none" });
            $(".emailtipbox select").css({ "visibility": "inherit" });
        };
    ...
    $("#email").emailMatch({ wrapLayer: ".emailtipbox" });