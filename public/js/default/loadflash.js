...
function showFlash(swf, w, h, loop)
{
	...
	s += '<embed src="'+sanitizeForbiddenHTMLTextChars(swf)+'" FlashVars="initialURL='+
			sanitizeForbiddenHTMLTextChars(location)+
			'&isMSIE='+isMSIE+'&useBSM=false" menu="false" quality="best" width="'+w+'" height="'+h+'" loop="'+loop+'" name="SlideContent" align="" type="application/x-shockwave-flash" pluginspage="' + protocol + '://www.macromedia.com/go/getflashplayer" swLiveConnect="true" allowScriptAccess="sameDomain" wmode="opaque"></embed>'
	s += '</object>'
	...
	{
		s = '<table border=0 width="100%" height="100%"><tr valign="top"><td align="center">' +
			s +
			'</td></tr></table>';
	}
	document.write(s);
