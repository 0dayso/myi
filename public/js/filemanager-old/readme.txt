...
FileManager can view SWF files, too. MP4, WebM and OGG videos are supported via HTML5 video. This only works if your
browser supports HTML5 and the above video formats. For the video formats MP4 and FLV, the OOS FlvPlayer is being
used as a fallback. This also requires Flash 9+ on the client side.
