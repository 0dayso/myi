...
<script src="<?php print $fmWebPath; ?>/ext/soundmanager/soundmanager2-nodebug-jsmin.js" type="text/javascript"></script>
<script src="<?php print $fmWebPath; ?>/ext/soundmanager/player-min.js" type="text/javascript"></script>
...
<link rel="stylesheet" href="<?php print $fmWebPath; ?>/ext/soundmanager/player.css" type="text/css">

<script type="text/javascript">
soundManager.debugMode = false;
soundManager.useFlashBlock = false;
soundManager.url = fmWebPath + '/ext/soundmanager/';
soundManager.flashVersion = 9;
soundManager.useMovieStar = true;
soundManager.useHTML5Audio = true;
soundManager.onready(function() {
	if(!fmSoundManagerReady) {
		pagePlayer = new PagePlayer();
		pagePlayer.init();
		fmSoundManagerReady = soundManager.supported();
	}
});
</script>
...
<input type="checkbox" name="fmReplSpaces" value="1"<?php if($fmReplSpacesUpload) print ' checked="checked"'; ?>/>
file name =&gt; file_name<br/>
<input type="checkbox" name="fmLowerCase" value="1"<?php if($fmLowerCaseUpload) print ' checked="checked"'; ?>/>
FileName =&gt; filename
</div>
</form>
</td>
...
<div id="fmMediaCont" style="background-color:black"></div></td>
</tr></table>
</div>
